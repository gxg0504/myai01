...
with tf.Session() as sess:
    ...
    loss_history = model.train(sess, data, from_scratch=True, save_path=model.ckpt_dir+'epoch_{%s}_sampling'%model.n_epoch)
...
with tf.Session() as sess:
    ...
    for input_batch, target_batch in zip(input_batches, target_batches):
        ...
        model.inference(sess, data, load_ckpt=model.ckpt_dir+'epoch_{%s}_sampling' % model.n_epoch)
